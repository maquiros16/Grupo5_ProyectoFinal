...
Aplicación de escritorio desarrollada en Python para administrar estudiantes, salas y reservaciones de salas de estudio. El sistema utilizará SQLite para conservar la información y permitirá aplicar validaciones, consultar disponibilidad, generar reportes y mantener un historial de auditoría.
